...
@mock_backend_response({"remote": {"get_status": {"status": "missing", "something_else": "duh!"}}})
...
@mock_backend_response({"remote": {"get_status": {"status": "whatever"}, "generate_ca": {"authority": "whatever"}}})
